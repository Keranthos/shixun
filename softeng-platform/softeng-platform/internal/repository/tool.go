...
func (r *toolRepository) CollectTool(ctx context.Context, userID int, resourceID string) error {
	...
	r.syncToolCollectionCount(ctx, resourceID)
	return err
}
...
// syncToolCollectionCount 用 collections 表真实条数回写 tools.collections，避免冗余字段漂移
func (r *toolRepository) syncToolCollectionCount(ctx context.Context, resourceID string) {
