...
func NewToolHandler(toolService service.ToolService, ragHook *service.RagIndexHook) *ToolHandler {
	return &ToolHandler{toolService: toolService, ragHook: ragHook}
}
...
func (h *ToolHandler) UpdateTool(c *gin.Context) {
	...
	if h.ragHook != nil {
		h.ragHook.OnResourceChanged("tool", resourceID)
	}
