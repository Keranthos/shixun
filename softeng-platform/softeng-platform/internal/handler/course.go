...
func NewCourseHandler(courseService service.CourseService, ragHook *service.RagIndexHook) *CourseHandler {
	return &CourseHandler{courseService: courseService, ragHook: ragHook}
}
...
func (h *CourseHandler) UploadResource(c *gin.Context) {
	...
	hookCourseUploadResources(h, result)
