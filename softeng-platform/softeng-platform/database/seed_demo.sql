...
(1, 'course', '软件工程导论', '2-2', 3, '覆盖生命周期、敏捷与质量基础，配合案例研讨。', 'https://picsum.photos/seed/c1/800/500', 820, 68, 52, '2024-02-01 08:00:00'),
(2, 'course', '数据库系统原理', '2-2', 3, '关系模型、SQL、事务与索引，含实验与课程设计衔接。', 'https://picsum.photos/seed/c2/800/500', 760, 62, 48, '2024-02-02 09:00:00'),
(3, 'course', 'Web 开发技术', '2-2', 2, 'HTML/CSS/JS 与现代前端框架入门，完成小型全栈项目。', 'https://picsum.photos/seed/c3/800/500', 920, 74, 61, '2024-02-03 10:00:00'),
(4, 'course', '软件项目管理', '2-2', 2, '进度、成本、风险与干系人管理，结合看板实践。', 'https://picsum.photos/seed/c4/800/500', 540, 44, 36, '2024-02-04 11:00:00'),
(5, 'course', '软件测试与质量保证', '2-2', 2, '黑盒/白盒、自动化与持续测试流水线概念。', 'https://picsum.photos/seed/c5/800/500', 510, 40, 33, '2024-02-05 12:00:00'),
(6, 'course', '数据结构与算法', '2-1', 4, '复杂度分析、常用结构与算法策略，为面试与竞赛打基础。', 'https://picsum.photos/seed/c6/800/500', 1200, 96, 78, '2023-09-01 08:00:00'),
(7, 'course', '操作系统', '2-1', 3, '进程、内存、文件系统与并发，配套实验镜像。', 'https://picsum.photos/seed/c7/800/500', 880, 70, 55, '2023-09-02 09:00:00'),
(8, 'course', '计算机网络', '2-1', 3, '分层模型、TCP/IP 与常见应用协议实验。', 'https://picsum.photos/seed/c8/800/500', 790, 58, 47, '2023-09-03 10:00:00'),
(9, 'course', '移动应用开发', '3-1', 2, '跨平台与原生路线对比，完成可演示的移动原型。', 'https://picsum.photos/seed/c9/800/500', 120, 10, 8, NOW()),
(10, 'course', '人工智能基础', '3-1', 3, '机器学习流程、常见模型与伦理讨论入门。', 'https://picsum.photos/seed/c10/800/500', 95, 8, 6, NOW());
